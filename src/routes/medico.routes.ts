...
import { EditarDiagnosticoComponent } from 'src/app/components/tabla-diagnostico/editar-diagnostico/editar-diagnostico.component';
...
export const MEDICO_ROUTES: Routes = [
    ...
    {path: 'pacientes',data:{crumb: 'Pacientes'},children:[
        ...
        {path: 'editar-diagnostico/:id', component:EditarDiagnosticoComponent,canActivate:[AccessGuard,DoctorGuard],data:{crumb: 'Diagnostico'}},
